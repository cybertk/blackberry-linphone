...
public final class Response extends Message {
	...
	/**
	 * The server is rejecting the request because the value of the 
	 * Session-Expires header is lower than the local Min-SE
	 * 
	 * @since v1.2
	 */
    ...
    /** Get the status code (convenience function).
     ...
     *@return true if the parameter is between the range [200,700).
     */
    ...
    /** Return true if the response is 2xx successful response.
     *@param rc is the return code.
     *@return true if the parameter is between the range [200,300).
     */
    public static boolean isSuccessfulResponse(int rc) {
        return rc >= 200 && rc < 300;
    }
    
    /** Is this a successful 2xx response?
     *@return true if this is a successful response.
     */
    public boolean isSuccessfulResponse() {
        return isSuccessfulResponse(statusLine.getStatusCode());
    }
    ...
    public String getFirstLine() {
        if (this.statusLine == null) return null;
