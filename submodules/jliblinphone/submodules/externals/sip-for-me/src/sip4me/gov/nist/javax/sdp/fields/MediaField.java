...
public class MediaField extends SDPField {
	...
	/**
	 * Returns the type (audio,video etc) of the media defined by this
	 * description.
	 * 
	...
	/**
	 * Adds a media format to the media description. Each element in this Vector
	 * should be an String value which matches one of the a=rtpmap: attribute
	 * fields of the media description.
	 * 
	 * @param mediaFormats
	 *            the format to add.
	 * @throws SdpException
