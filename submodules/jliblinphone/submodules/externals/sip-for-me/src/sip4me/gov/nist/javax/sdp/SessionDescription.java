 ...
 *         domain.</a>
 * 
 *         Acknowledgment: Bug reports and corrections by Andreas Bystrom and
 *         Sverker Abrahamsson.
 */
public class SessionDescription {
	...
	/** Creates new SessionDescription */
	...
	/**
	 * Sets the value of the specified attribute, or adds it if it is not there.
	 * 
	 * @param name
	 *            name - the name of the attribute.
	 * @param value
	...
	/**
	 * Utility method for cloning a Vector Acknowledgement - this code was
	 * contributed by Sverker Abrahamsson.
	 */
