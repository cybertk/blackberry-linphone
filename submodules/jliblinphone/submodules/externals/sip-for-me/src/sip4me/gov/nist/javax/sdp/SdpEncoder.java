 ...
 *
 */
public class SdpEncoder {

    /** Creates new SdpEncoder */
    public SdpEncoder() {
    }
     ...
     * values. This makes the session description more readable but may have an 
     * adverse effect on serialization time.
     *
     * Ordinarily time values are given in numbers of seconds, but for readability
     * they may be specified using logical units. From RFC 2327:
     *
